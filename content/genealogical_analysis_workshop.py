...
class Workbook:
    css = """<style>
        ...
        .exercise dt {color: white; background-color: green;
    ...
    <button type="button" onclick="clear_storage(this)">Clear JupyterLite local
    storage</button> then reload this web page.</div>
    """

    # Used for making SVG formatting smaller
    small_class = "x-lab-sml"
    small_style = (
        ".x-lab-sml .sym {transform:scale(0.6)} .x-lab-sml "
        ".lab {font-size:7pt;}"  # All labels small
        ".x-lab-sml .x-axis .tick .lab {"
        "font-weight:normal;transform:rotate(90deg);"
...
class Workbook1(Workbook):
    def __init__(self):
        ...
        assert (
            len(self.ts.site(12).mutations) == 2
        )  # check there are sites with multiple mutations
                    ...
                    "answers": [
                        {
                            ...
                            "correct": True,
                            "feedback": (
                                "Correct: there may be more mutations than sites "
                                "because there could be multiple mutations at a "
                                "single site"
                            ),
                        },
                        {
                            ...
                            "correct": False,
                            "feedback": (
                                "Try again (hint: look at `ts.num_mutations()`)"
                            ),
                        },
                    ],
                },
    ...
    def Q2a(self):
        display_quiz(
            [
                {
                    "question": (
                        "With regard to (sample) nodes in a tree sequence, select "
                        "the true statements below"
                    ),
                    "type": "many_choice",
                    "answers": [
                        {
                            ...
                            "correct": False,
                            "feedback": (
                                "There are usually other nodes in a tree sequence, "
                                "e.g. representing ancestral genomes"
                            ),
                        },
                        {
                            "answer": (
                                "Each sample in a tree sequence is represented by "
                                "a node"
                            ),
                            "correct": True,
                            "feedback": "",
                        ...
                        {
                            "answer": (
                                "All nodes have a unique ID starting at "
                                "<code>0</code>"
                            ),
                            "correct": True,
                            "feedback": "",
                        ...
                        {
                            "answer": (
                                "Sample nodes are always placed at the most recent "
                                "time (<em>node.time=0</em>)"
                            ),
                            "correct": False,
                            "feedback": (
                                "Although genomes are often sampled from the present "
                                "day (node.time=0), this is not a strict requirement"
                            ),
                        },
                        {
                            "answer": (
                                "Sample nodes are commonly placed at the oldest time "
                                "(<em>node.time>0</em>)"
                            ),
                            "correct": False,
                            "feedback": (
                                "Sample nodes tend to be at recent times (often at "
                                "time 0)"
                            ),
                        },
                        {
                            "answer": (
                                "Sample nodes are commonly placed at the most "
                                "recent time (<em>node.time=0</em>)"
                            ),
                            "correct": True,
                            "feedback": "",
                        },
                        {
                            "answer": (
                                "Although sample nodes commonly have IDs from "
                                "<code>0</code> to <code>num_samples</code>, this "
                                "should not be relied upon"
                            ),
                            "correct": False,
                            "feedback": (
                                "Almost right, but think about the zero-based ID "
                                "numbering"
                            ),
                        },
                        {
                            "answer": (
                                "Although sample nodes commonly have IDs from "
                                "<code>0</code> to <code>num_samples-1</code>, "
                        ...
                        {
                            "answer": (
                                "Sample nodes always have sequential IDs allocated "
                                "from <code>0</code> upwards"
                            ),
                            "correct": False,
                            "feedback": (
                                "Often, software like `msprime` will assign "
                                "sequential node IDs from zero upwards to the samples, "
                                "but this is not a strict requirement, and other "
                                "software may not do this"
                            ),
                        },
                        {
                            "answer": "A node represents a haploid genome",
                            "correct": True,
                            "feedback": "",
                        },
                        {
                            "answer": "A node represents a diploid genome",
                            "correct": False,
                            "feedback": (
                                "Each diploid genome is represented by 2 nodes in a "
                                "tree sequence"
                            ),
                        },
                    ],
    ...
    def Q2b(self):
        display_quiz(
            [
                {
                    "question": (
                        "Harder question about sample nodes: select the true "
                        "statements below"
                    ),
                    "type": "many_choice",
                    "answers": [
                        {
                            "answer": (
                                "The genealogy shows the known ancestral "
                                "relationships between the sample nodes"
                            ),
                            "correct": True,
                            "feedback": "",
                        },
                        {
                            "answer": (
                                "Samples are always represented by 'leaves' (tips) in "
                                "the genealogy (i.e. they never have descendants)"
                            ),
                            "correct": False,
                            "feedback": (
                                "Yes: although tree sequences are often constructed "
                                "such that samples are leaf nodes with no descendants, "
                                "it is also possible to have 'internal nodes' as "
                                "samples"
                            ),
                        },
                        {
                            "answer": (
                                "Samples are never represented by 'leaves' (tips) in "
                                "the genealogy"
                            ),
                            "correct": False,
                            "feedback": (
                                "It is common for a tree sequence sample to have no "
                                "descendants (i.e. be a 'leaf' in the genealogy)"
                            ),
                        },
                        {
                            "answer": (
                                "Samples are often represented by 'leaves' (tips) "
                                "in the genealogy (i.e. commonly have no descendants)"
                            ),
                            "correct": True,
                            "feedback": (
                                "Although most of the trees in this workbook have "
                                "samples on the leaves of local trees, it is also "
                                "possible to sample historical genomes, in which case "
                                "samples can have descendants."
                            ),
                        },
                    ],
                }
    ...
    def Q4(self):
        ...
        display_quiz(
            [
                {
                    "question": (
                        "How many mutations in total are there in the tree at "
                        "position 400 Kb?"
                    ),
                    "type": "numeric",
                    "answers": [
                ...
                {
                    "question": (
                        "How many singleton mutations (above one sample, i.e. on a "
                        "terminal branch) are there in the tree at position 400 Kb?"
                    ),
                    "type": "numeric",
                    "answers": [
                        {
                ...
                {
                    "question": (
                        "How many doubleton mutations (above 2 samples) are there in "
                        "the tree at position 400 Kb?"
                    ),
                    "type": "numeric",
                    "answers": [
                        {
    ...
    def Q5(self):
        display_quiz(
            [
                {
                    "question": (
                        "What is the age (to the nearest generation) of the root in "
                        "the first tree?"
                    ),
                    "type": "numeric",
                    "precision": 0,
                    "answers": [
                        ...
                        },
                        {
                            ...
                            "correct": False,
                            "feedback": "Try again (hint: the root node in the tree "
    ...
    def Q6a(self):
        ...
        display_quiz(
            [
                {
                    "question": (
                        "What is the name of the individual associated with sample "
                        "node 14 in the original tree sequence?"
                    ),
                    ...
                    "answers": [
                        {
                            ...
                            "feedback": (
                                "Correct"
                                if i.metadata["name"] == correct_name
                    ...
                    "answers": [
                        {
                            ...
                            "correct": True,
                            "feedback": (
                                "Correct. All nodes in the tree sequence belong to the "
                                "same population (imaginatively named 'pop_0')"
                            ),
                        },
                        {
                            "type": "range",
            ...
            [
                {
                    ...
                    "answers": [
                        {
                            "answer": "Homozygous AA",
                            "correct": False,
                            "feedback": "Try again",
                        },
                        {
                            "answer": "Heterozygous AC",
                            "correct": True,
                            "feedback": "Correct",
                        },
                        {
                            "answer": "Homozygous CC",
                            "correct": False,
                            "feedback": "Try again",
                        },
                    ],
    ...
    def Q7b(self):
        ...
        display_quiz(
            [
                {
                    "question": (
                        "What is the genotypic state of the first sample at the first "
                        "site?"
                    ),
                    "type": "multiple_choice",
                    "answers": [
                        {
                            ...
                            "correct": (a1 == s),
                            "feedback": (
                                "Correct" if a1 == s else "Sorry, that's not right."
                            ),
                        }
                        for s in [0, 1]
                    ],
                ...
                {
                    "question": (
                        "What is the genotypic state of the second sample at the last "
                        "site?"
                    ),
                    "type": "multiple_choice",
                    "answers": [
                        {
                            ...
                            "correct": (a2 == s),
                            "feedback": (
                                "Correct" if a2 == s else "Sorry, that's not right."
                            ),
                        }
                        for s in [0, 1]
                    ],
...
def make_stepping_stone_8(mu, rho, ploidy):
    ...
    demography = msprime.Demography.stepping_stone_model(
        [deme_size] * num_demes, migration_rate=0.05
    )
    ts = msprime.sim_ancestry(
    ...
    mts = msprime.sim_mutations(
        ts, rate=mu, random_seed=321  # human-like mutation rate
    )
    return (
        mts,
        demography,
...
class Workbook2(Workbook):
    def __init__(self):
        small_ts = msprime.sim_ancestry(
            ...
            population_size=20_000,  # a rough "effective population size" suitable
            # for humans
            random_seed=107,
        )
    ...
    def Q2(self):
        display_quiz(
            [
                {
                    "question": "What is the ID of the site with two mutations?",
                    "type": "numeric",
                    "precision": 0,
                    "answers": [
                        {
    ...
    def Q3(self):
        display_quiz(
            [
                {
                    "question": "How many variable sites are in the tree sequence?",
                    "type": "numeric",
                    "precision": 0,
                    "answers": [
                        {
                ...
                },
                {
                    ...
                    "answers": [
                        ...
                        },
                        {
                            ...
                            "correct": False,
                            "feedback": (
                                "Try again (hint - look at the 'Total Size' in the "
                                "output table"
                            ),
                        },
                    ],
    ...
    def Q4(self):
        display_quiz(
            [
                {
                    "question": (
                        "What was the publication date of the study on which the "
                        "AmericanAdmixture_4B11 model is based?"
                    ),
                    "type": "numeric",
                    "precision": 0,
                    "answers": [
    ...
    def Q5(self):
        display_quiz(
            [
                {
                    "question": (
                        "The average tMRCA does not differ that much between "
                        "populations, showing that even between two (say) European "
                        "genomes, most diversity is expect to trace back to Africa. "
                        "Nevertheless, some populations have a higher average tMRCA "
                        "(i.e. expected genetic diversity) than others. According to "
                        "the simulation, which population has the most recent average "
                        "genome-wide tMRCA (least expected genetic diversity)?"
                    ),
                    "type": "multiple_choice",
                    "answers": [
                        {
                ...
                {
                    "question": (
                        "And which population has the oldest average genome-wide "
                        "tMRCA (most expected genetic diversity)?"
                    ),
                    "type": "multiple_choice",
                    "answers": [
    ...
    def Q6(self):
        display_quiz(
            [
                {
                    "question": (
                        "What is the site-based Fst between population 0 and "
                        "population 3 (to 4 decimal places)?"
                    ),
                    "type": "numeric",
                    "precision": 4,
                    "answers": [
    ...
    def Q7(self):
        display_quiz(
            [
                {
                    "question": (
                        "What is the mean branch-length Fst between samples from "
                        "pop_0 and pop_1 (to 4 decimal places)?"
                    ),
                    "type": "numeric",
                    "precision": 4,
                    "answers": [
...
class Workbook3(Workbook):
    def __init__(self):
        ...
        for i in (-1, -2):
            assert json.dumps(
                json.loads(self.sim_ts.provenance(-2).record)["parameters"]
            ) == json.dumps(json.loads(comp_ts.provenance(-2).record)["parameters"])
        tsinfer.SampleData.from_tree_sequence(
            self.sim_ts, path="data/simulated_8pop.samples"
        )
    ...
    def Q1(self):
        display_quiz(
            [
                {
                    "question": (
                        "The first site was used for inference; what is "
                        "its inference_type (as described in its metadata)?"
                    ),
                    "type": "multiple_choice",
                    "answers": [
                        {
                        ...
                        {"answer": "fuzzy", "correct": False, "feedback": "Try again"},
                        {
                            "answer": "potato",
                            "correct": False,
                            "feedback": "Really? You're joking, right?",
                        },
                    ],
                },
            ]
    ...
    def Q1bonus(self):
        display_quiz(
            [
                {
                    "question": (
                        "In plot (c), inferred using the default mismatch "
                        "ratio of 1, how many sites between 110 kb - 120 kb "
                        "have been wrongly inferred to have multiple mutations?"
                    ),
                    "type": "numeric",
                    "precision": 0,
                    "answers": [
    ...
    def Q2(self):
        display_quiz(
            [
                {
                    "question": (
                        "What is the site-based genetic diversity in both"
                        " the original and inferred tree sequences "
                        " (to 5 decimal places)?"
                    ),
                    "type": "numeric",
                    "precision": 5,
                    "answers": [
                        {
                            ...
                            "value": round(
                                float(
                                    tskit.load("data/simulated_8pop.trees").diversity()
                                ),
                                5,
                            ),
                            "correct": True,
                            "feedback": (
                                "Correct: since this is a site-base measure, the same"
                                " value will be obtained regardless of how accurately"
                                "the genealogy has been inferred."
                            ),
                        },
                        {
                            "type": "range",
