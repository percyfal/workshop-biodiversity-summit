...
and requires fairly large sample sizes leverage power of data
...
::::: {#fig-motacilla layout-ncol=4}

![](assets/images/Yarrellii.jpg){height=70px}

![](assets/images/Personata.jpg){height=70px}

![](assets/images/Baicalensis.jpg){height=70px}

![](assets/images/Alba.jpg){height=70px}

![](assets/images/Alboides2.jpg){height=70px}

![](assets/images/Leucopsis.jpg){height=70px}

![](assets/images/Lugens.jpg){height=70px}

![](assets/images/Ocularis.jpg){height=70px}

![](assets/images/Subpersonata.jpg){height=70px}
...
Alström. Source code at <https://github.com/percyfal/tswf>
